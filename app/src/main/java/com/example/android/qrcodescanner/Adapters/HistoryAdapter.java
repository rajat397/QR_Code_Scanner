...
import com.example.android.qrcodescanner.ResultDisplayActivity;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

import java.text.SimpleDateFormat;

public class HistoryAdapter extends FirebaseRecyclerAdapter<Record,HistoryAdapter.viewHolder> {


    Context context;

    public HistoryAdapter(Context context, @NonNull FirebaseRecyclerOptions<Record> options) {
        super(options);
